...
// Print("[TIME] : Current: "+ TimeToString(TimeCurrent(), TIME_DATE|TIME_MINUTES)+" GMT: "+ TimeToString(TimeGMT(), TIME_DATE|TIME_MINUTES));
   Print("[SLOW COPEN]:: cp120: " + util.getSigString(hSig.cpSlopeCandle120SIG)  + " cCloseSIG3: " + util.getSigString(hSig.composite_CloseSIG_3) + " cCloseSIG4: " + util.getSigString(hSig.composite_CloseSIG_4)  + " tradeSlopeSig: "+ util.getSigString(ss.tradeSlopeSIG)+" slopeAnalyzerSIG: "+util.getSigString(ss.slopeAnalyzerSIG)); 
   ...
   Print("[TRADESIG] :: Trade Sig: " + util.getSigString(hSig.tradeSIG) + " Base Slope: " + util.getSigString(hSig.baseSlopeSIG) + " Base Slope: " + ss.baseSlopeData.val1 + " rsiSIG: " + util.getSigString(ss.rsiSIG) + " volSIG:" + util.getSigString(ss.volSIG) + " volSlopeSIG: " + util.getSigString(ss.volSlopeSIG) + " atr: " + util.getSigString(ss.atrSIG)+" ATR: "+NormalizeDouble((((indData.atr[1] / util.getPipValue(_Symbol)))/((_Period > 1) ? log(_Period) : _Period)),3)); 
   return sigBuff;
}
