...
// Print("[TIME] : Current: "+ TimeToString(TimeCurrent(), TIME_DATE|TIME_MINUTES)+" GMT: "+ TimeToString(TimeGMT(), TIME_DATE|TIME_MINUTES));
   Print("[OPEN] :: Slope30: " + util.getSigString(hSig.simpleSlope_30_SIG) + " fastSIG: " + util.getSigString(hSig.fastSIG) + " obvCPSIG: " + util.getSigString(ss.obvCPSIG) + " cpScatt: " + util.getSigString(ss.cpScatterSIG) + " sVarSIG: " + util.getSigString(ss.slopeVarSIG) + " cV120SIG: " + util.getSigString(ss.candleVol120SIG)); //+" hilbertDftSIG: "+util.getSigString((SAN_SIGNAL)ss.hilbertDftSIG.val[0]));
   Print("[COPEN]:: domSIG: " + util.getSigString(dominantSIG) +" cp120: " + util.getSigString(hSig.cpSlopeCandle120SIG) + " slope120: " + util.getSigString(hSig.slopeCandle120SIG) + " cCloseSIG1: " + util.getSigString(hSig.composite_CloseSIG_1) + " cCloseSIG2: " + util.getSigString(hSig.composite_CloseSIG_2) + " cCloseSIG3: " + util.getSigString(hSig.composite_CloseSIG_3) + " c_SIG: " + util.getSigString(hSig.c_SIG) +" tradeSlopeSig: "+ util.getSigString(ss.tradeSlopeSIG) + " Base Slope: " + util.getSigString(hSig.baseSlopeSIG)); 
