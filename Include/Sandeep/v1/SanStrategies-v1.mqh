...
// Print("[TIME] : Current: "+ TimeToString(TimeCurrent(), TIME_DATE|TIME_MINUTES)+" GMT: "+ TimeToString(TimeGMT(), TIME_DATE|TIME_MINUTES));
   ...
   Print("[TRADESIG] :: Trade Sig: " + util.getSigString(hSig.tradeSIG) + " Base Slope: " + util.getSigString(hSig.baseSlopeSIG) + " Base Slope: " + ss.baseSlopeData.val1 + " rsiSIG: " + util.getSigString(ss.rsiSIG) + " volSIG:" + util.getSigString(ss.volSIG) + " volSlopeSIG: " + util.getSigString(ss.volSlopeSIG) + " atr: " + util.getSigString(ss.atrSIG) + " obvCPSIG: " + util.getSigString(ss.obvCPSIG)); //+" hilbertSIG: "+util.getSigString((SAN_SIGNAL)ss.hilbertSIG.val4)+" dftSIG: "+ util.getSigString((SAN_SIGNAL)ss.dftSIG.val5));
   return sigBuff;
}
