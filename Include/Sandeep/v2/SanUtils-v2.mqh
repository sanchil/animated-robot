...
#include <Sandeep/v2/SanTypes-v2.mqh>
...
public:
   ...
   double            normalizeForTimeFrame(const double value);
   ...
   if(_Period < 60)
     {
      ...
      if((_Period >= 60) && (_Period < 1440))
        {
         recordFreq = (int)(_Period / 60);
         currentRecordTime = currHour;
        }
      else
         if((_Period >= 1440) && (_Period < 43200))
           {
   ...
   if((resultIma14 == 0) || (resultIma30 == 0) || (resultFAST == 0))
     {
      ...
      if((resultIma120 == 0) || (resultMEDIUM == 0))
        {
         // Print(" Variablity MEDIUM or 30");
         inRangeBool = (notMean && notHalf);
         inNegRangeBool = (inRangeBool && ltThanHalf);
         ...
         if((resultIma240 == 0) || (resultSLOW == 0))
           {
            // Print(" Variablity SLOW or 120");
            inRangeBool = (notMean);
